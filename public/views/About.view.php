    ...
    <main>
        <div class="container">
            ...
            <p class="fs-4 lh-lg">
                ...
                Puedes usar dos versiones, la primera es la versión de invitado donde puedes usar rápidamente la aplicación de un modo sencillo, te permite crear tareas y eliminarlas durante la sesión de tu navegador, la segunda opción es
                ...
                quieres usar rápidamente la app o dar un vistazo rápido, ve a la opción de "Modo invitado" para usarlo. Agradecemos que uses nuestra aplicación y ante cualquier comentario, sugerencia o aporte que desees realizar, puedes
